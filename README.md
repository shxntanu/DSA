...
Collection of DSA Problems from LeetCode and other sources (not as likely) and solved in Rust, [C](https://github.com/shxntanu/DSA), [C++](https://github.com/shxntanu/DSA/tree/C++), [Java](https://github.com/shxntanu/DSA/tree/java) and [Python](https://github.com/shxntanu/DSA/tree/Python).

![Static Badge](https://img.shields.io/badge/Rust-blue)<br/>
